...
diurnals_2019_swp_vs_time<- diurnals_2019_lwp_vs_time %>%
  ...
  select(datetime, day, Stem_wp_MPa, treatment,date1)
...
for (current_date in dates) {
  ...
  anova_result <- aov(Stem_wp_MPa ~ treatment, data = data_subset)
...
diurnals_2019_lwp_midday<- diurnals_2019_lwp_vs_time %>%
  ...
  filter(round == "4" )%>%
  select(datetime, day, Leaf_wp_MPa, treatment,date1)
...
#####NEW FIGURE WATER POTENTIAL WITH IRRIGATION FRO 2019 AND 2020 BH HEATWAVE######



panel_plot_irrigation_water_potentials_bh_2019_2020<- plot_grid(BH_2019_leaf_predawn_plot,BH_2020_lwp_predawn_plot,BH_2019_swp_midday_plot, BH_2020_swp_midday_plot,daily_irr_tmax_2019_HW_plot_date_selection,daily_irr_tmax_2020_HW_plot_date_selection,phenological_bar_plot_2019, phenological_bar_plot_2020,
...
panel_plot_irrigation_water_potentials_bh_2019_2020 <- plot_grid(
  plot_grid(BH_2019_leaf_predawn_plot, BH_2020_lwp_predawn_plot, BH_2019_swp_midday_plot, BH_2020_swp_midday_plot,
...
ggsave(panel_plot_irrigation_water_potentials_bh_2019_2020, filename = "figures/panel_plot_irrigation_water_potentials_bh_2019_2020.pdf", device = cairo_pdf, width = 23, height =20)


panel_plot_irrigation_water_potentials_bh_2019_2020_with_pheno_bar<-plot_grid(panel_plot_irrigation_water_potentials_bh_2019_2020, phenological_bar_plot_2019,phenological_bar_plot_2020, ncol = 2,
                                                              rel_heights = c(4,0.4)
)
